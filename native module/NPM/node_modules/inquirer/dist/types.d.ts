...
}, answers: NoInfer<Partial<A>>) => void | T | Promise<T>;
...
export type PromptModuleNamedQuestion<A extends Answers, Prompts extends Record<string, Record<string, any>> = never, Flat extends Answers = A> = PromptModuleSpecificQuestion<A, Prompts> & {
